...
namespace ProtoSprite.Editor
{
    ...
    [System.Serializable]
    public class UndoDataResizeTexture
    {
        [SerializeField] public Texture2D texture = null;
    ...
    [System.Serializable]
    public class UndoDataResizeTextureGroup : UndoDataBase
    {
        [SerializeField] public UndoDataResizeTexture[] commands = null;
