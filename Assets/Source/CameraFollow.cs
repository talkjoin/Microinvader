// CameraFollow.cs
// Attach to the Main Camera. Smoothly tracks the player within dungeon bounds.
...
public class CameraFollow : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        transform.position = Vector3.SmoothDamp(transform.position, des, ref _vel, SmoothTime);
    }

    public void SetTarget(Transform t) => Target = t;
    public void SetBounds(Vector2 min, Vector2 max) { BoundsMin = min; BoundsMax = max; }
}
